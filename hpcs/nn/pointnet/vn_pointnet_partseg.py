...
from hpcs.nn.pointnet.utils.vn_layers import *
from hpcs.nn.pointnet.vn_pointnet import STNkd
from hpcs.nn.pointnet.utils.vn_dgcnn_util import get_graph_feature_cross
...
class VN_POINTNET_partseg(nn.Module):
    def __init__(self, normal_channel, num_part, k, pooling):
        ...
        self.fstn = STNkd(pooling=self.pooling, d=128 // 3)
