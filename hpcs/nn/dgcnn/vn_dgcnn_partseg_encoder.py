...
class VN_DGCNN_partseg_encoder(nn.Module):
    def __init__(self, in_channels, out_features, k, dropout, pooling):
        super(VN_DGCNN_partseg_encoder, self).__init__()
        ...
        self.conv9 = nn.Sequential(nn.Conv1d(256, self.out_features, kernel_size=1, bias=False),
                                   self.bn9,
                                   nn.LeakyReLU(negative_slope=0.2))
