...
class VN_DGCNN_partseg_class(nn.Module):
    def __init__(self, in_channels, out_features, k, dropout, pooling):
        ...
        self.conv3 = VNLinearLeakyReLU(64 // 3, 64 // 3)
        self.conv4 = VNLinearLeakyReLU(64 // 3 * 2, 64 // 3)
        self.conv5 = VNLinearLeakyReLU(64 // 3, 64 // 3)
        self.conv6 = VNLinearLeakyReLU(64 // 3, 64 // 3)
        self.conv7 = VNLinearLeakyReLU(64 // 3 * 2, 64 // 3)
        self.conv8 = VNLinearLeakyReLU(64 // 3, 64 // 3)
        ...
        self.conv9 = nn.Sequential(nn.Conv1d(63, 256, kernel_size=1, bias=False),
                                   self.bn8,
        ...
        self.conv11 = nn.Sequential(nn.Conv1d(256, 128, kernel_size=1, bias=False),
                                    self.bn10,
                                    nn.LeakyReLU(negative_slope=0.2))
        self.conv12 = nn.Conv1d(128, self.out_features, kernel_size=1, bias=False)
    ...
    def forward(self, x):
        ...
        x = x3.view(batch_size, -1, num_points)
